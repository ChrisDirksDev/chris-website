...
const HomeContent = ({onContactClick}) => {
    return (
      <div className="HomeContent  items-center flex flex-column">
        ...
        <div className="flex hotlinks f1 lh-copy ms mt7">Check out the <span  onClick={() =>{onContactClick("PROJECTS")}} className="underline white pointer">projects</span> I've worked on or <span onClick={() =>{onContactClick("INTERESTS")}} className="underline white pointer">things</span> I'm interested in.</div>
        {/* <p className='contact-link white sl f-headline pa2 lh-solid' onClick={onContactClick}>Get In Touch</p> */}
